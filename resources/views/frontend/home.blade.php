...
<link rel="stylesheet" href="https://unpkg.com/leaflet-control-geocoder/dist/Control.Geocoder.css" />
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-12 col-md-7 col-lg-6">
                    ...
                    <h1 class="banner-title"> {{ __('frontend.organic_&_tasty_food_for_your_table') }} </h1>
                ...
                <div class="col-12 col-md-5 col-lg-6">
                    <div class="banner-image">
                        @php
                            ...
                            $filename = setting('banner_image'); // Get the base filename
                            $localizedFilename = str_replace(
                                                                '.' . pathinfo($filename, PATHINFO_EXTENSION),
                                                                '_' . $lang . '.' . pathinfo($filename, PATHINFO_EXTENSION),
                                                                $filename
                                                            );
                        @endphp
                        {{-- {{$pathInfo}} --}}
                        <img src="{{ asset('images/' . $localizedFilename) }}" alt="hero">
    ...
    <!--========  FEATURE PART START ========-->
    <section class="feature" dir="{{ app()->getLocale() === 'ar' ? 'rtl' : 'ltr' }}">
        <div class="container">
            <span class="section-subtitle"> {{ __('frontend.how_to_order') }} </span>
            <h2 class="section-title"> {{ __('frontend.its_as_easy_as_this') }} </h2>
            ...
            <div class="swiper feature-swiper">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        ...
                        <h3> {{ __('frontend.provide_your_location') }} </h3>
                        <p> {{ __('frontend.fill_out_your_address_&_search') }} </p>
                    </div>
                    <div class="swiper-slide">
                        <svg width="70" height="70" viewBox="0 0 70 70" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h3> {{ __('frontend.choose_your_restaurant_&_food') }} </h3>
                        <p> {{ __('frontend.browse_through_many_restaurant') }}</p>
                    </div>
                    <div class="swiper-slide">
                        <svg width="70" height="70" viewBox="0 0 70 70" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h3> {{ __('frontend.pay_&_get_your_food') }} </h3>
                        <p> {{ __('frontend.pay_using_various_payment_methods') }}</p>
                    </div>
                ...
                <div class="row">
                    <div class="col-12 col-sm-6">
                        <div class="app-content">
                            <h2>{{ __('frontend.download_the_app') }} </h2>
                            <p> {{ __('frontend.click_sit_back_and_enjoy') }}</p>
    ...
    @if (!blank($bestSellingCuisines))
        <section class="category section-gap-66" dir="{{ app()->getLocale() === 'ar' ? 'rtl' : 'ltr' }}">
            <div class="container">
